...
export function serializeTicketReminderDescription(
  note,
  { ticketId, ticketNumber, ticketType, requesterName, requesterContactId } = {}
) {
...
/** client_id effectif : priorité au ticket lié (demandeur / entreprise à jour). */
