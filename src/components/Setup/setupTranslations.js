...
// Aligné sur src/i18n/locales.js (popularité décroissante)
...
const en = {
  ...
  admin: {
    ...
    creating: "Creating…",
    alreadyCreated:
      "Your administrator account is already set up. Continue to configure two-factor authentication.",
  },
  mfa: {
    title: "Secure your administrator account",
    subtitle:
      "Two-factor authentication (MFA) is required. Scan the QR code with an app such as Microsoft Authenticator or Google Authenticator, then enter the 6-digit code.",
...
const fr = {
  ...
  admin: {
    ...
    creating: "Création…",
    alreadyCreated:
      "Votre compte administrateur est déjà créé. Continuez pour configurer l'authentification à deux facteurs.",
  },
  mfa: {
    title: "Sécurisez le compte administrateur",
    subtitle:
      "L'authentification à deux facteurs (MFA) est obligatoire. Scannez le QR code avec une application comme Microsoft Authenticator ou Google Authenticator, puis saisissez le code à 6 chiffres.",
...
const de = {
  ...
  database: {
    ...
    host: { label: "Server", hint: "Oft localhost oder die Adresse Ihres Hosters." },
    port: { label: "Port", hint: "Meist 5432." },
    name: { label: "Datenbankname", hint: "Die Datenbank muss bereits existieren." },
    user: { label: "Benutzer", hint: "Der Benutzer mit Zugriff auf diese Datenbank." },
    password: { label: "Passwort", hint: "Das Passwort dieses Benutzers." },
    back: "Zurück",
  ...
  admin: {
    ...
    email: { label: "E-Mail", hint: "Ihre Anmelde-E-Mail." },
    username: { label: "Anzeigename (optional)", hint: "So erscheint Ihr Name in der App." },
    password: { label: "Passwort", hint: "Verwenden Sie ein starkes Passwort (siehe Kriterien unten)." },
    passwordConfirm: { label: "Passwort bestätigen", hint: "Dasselbe Passwort erneut eingeben." },
    passwordStrength: {
      title: "Passwortstärke",
      strength: { empty: "—", weak: "Schwach", fair: "Mittel", strong: "Stark" },
      rules: {
    ...
    creating: "Erstellen…",
    alreadyCreated:
      "Ihr Administrator-Konto ist bereits eingerichtet. Fahren Sie mit der Zwei-Faktor-Authentifizierung fort.",
  },
  mfa: {
    title: "Administrator-Konto absichern",
    subtitle:
      "Zwei-Faktor-Authentifizierung (MFA) ist erforderlich. Scannen Sie den QR-Code mit einer App wie Microsoft Authenticator oder Google Authenticator und geben Sie den 6-stelligen Code ein.",
...
const it = {
  ...
  database: {
    ...
    host: { label: "Server", hint: "Spesso localhost o l'indirizzo del vostro hoster." },
    port: { label: "Porta", hint: "Di solito 5432." },
    name: { label: "Nome database", hint: "Il database deve già esistere." },
    user: { label: "Utente", hint: "L'utente che accede a questo database." },
    password: { label: "Password", hint: "La password di questo utente." },
    back: "Indietro",
  ...
  admin: {
    ...
    email: { label: "Email", hint: "La vostra email di accesso." },
    username: { label: "Nome visualizzato (opzionale)", hint: "Come appare il vostro nome nell'app." },
    password: { label: "Password", hint: "Usate una password forte (vedi i criteri sotto)." },
    passwordConfirm: { label: "Conferma password", hint: "Ripetere la stessa password." },
    passwordStrength: {
      title: "Forza password",
      strength: { empty: "—", weak: "Debole", fair: "Discreta", strong: "Forte" },
      rules: {
    ...
    creating: "Creazione…",
    alreadyCreated:
      "L'account amministratore è già stato creato. Continuate per configurare l'autenticazione a due fattori.",
  },
  mfa: {
    title: "Proteggete l'account amministratore",
    subtitle:
      "L'autenticazione a due fattori (MFA) è obbligatoria. Scansionate il QR code con un'app come Microsoft Authenticator o Google Authenticator, poi inserite il codice a 6 cifre.",
...
const es = {
  ...
  database: {
    ...
    host: { label: "Servidor", hint: "A menudo localhost o la dirección de su proveedor." },
    port: { label: "Puerto", hint: "Normalmente 5432." },
    name: { label: "Nombre de la base", hint: "La base debe existir ya." },
    user: { label: "Usuario", hint: "El usuario con acceso a esta base." },
    password: { label: "Contraseña", hint: "La contraseña de ese usuario." },
    back: "Volver",
  ...
  admin: {
    ...
    email: { label: "Correo electrónico", hint: "Su correo de acceso." },
    username: { label: "Nombre mostrado (opcional)", hint: "Cómo aparece su nombre en la app." },
    password: { label: "Contraseña", hint: "Use una contraseña segura (véase los criterios abajo)." },
    passwordConfirm: { label: "Confirmar contraseña", hint: "Escriba la misma contraseña otra vez." },
    passwordStrength: {
      title: "Fortaleza de la contraseña",
      strength: { empty: "—", weak: "Débil", fair: "Media", strong: "Fuerte" },
      rules: {
    ...
    creating: "Creando…",
    alreadyCreated:
      "Su cuenta de administrador ya está creada. Continúe para configurar la autenticación de dos factores.",
  },
  mfa: {
    title: "Proteja la cuenta de administrador",
    subtitle:
      "La autenticación de dos factores (MFA) es obligatoria. Escanee el código QR con una app como Microsoft Authenticator o Google Authenticator y escriba el código de 6 dígitos.",
...
export const setupTranslations = { en, fr, de, it, es };
