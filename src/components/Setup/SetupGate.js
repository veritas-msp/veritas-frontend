  ...
  useEffect(() => {
    ...
    const check = async () => {
      try {
        ...
        // Backend indisponible · laisser l'utilisateur atteindre /setup
    ...
    // Ne masquer l'app que lors du tout premier contrôle (évite un « reload » à chaque changement d'URL)
  ...
  if (!ready) {
    return (
      ...
      >
        ...
        />
        <p style={{ margin: 0, fontSize: "0.95rem" }}>Vérification de l&apos;installation…</p>
