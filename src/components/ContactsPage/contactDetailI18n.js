...
const DETAIL_COPY = {
  fr: {
    ...
    defaultName: "Contact",
    status: { active: "Actif", inactive: "Inactif", unknown: "Non renseigné" },
    ...
    guide: {
      steps: {
        hero: {
          ...
          content:
            "Retrouvez ici le nom, le statut, le poste, l'entreprise rattachée et les étiquettes. Le lien entreprise ouvre directement la fiche client.",
        },
        ticketBookmarks: {
          title: "Tickets en cours",
          content:
            "Accédez rapidement aux tickets ouverts ou récents de ce contact. Créez un nouveau ticket ou ouvrez la liste complète du support.",
        },
        coordinates: {
          title: "Coordonnées",
          content:
            "E-mails, téléphones et autres moyens de communication du contact. Cliquez sur une ligne pour appeler ou envoyer un message.",
        },
        activity: {
          title: "Activité MSP",
          content:
            "Consultez l'historique support, les demandes de prestation et les événements planifiés pour ce contact et son entreprise.",
        },
        portal: {
          title: "Portail client",
          content:
            "Gérez l'accès portail du contact : création de compte, activation, réinitialisation du mot de passe et suivi des connexions.",
        },
        sharedAccess: {
          title: "Partage d'accès",
          content:
            "Partagez un mot de passe ou un accès temporaire avec le contact sur son portail · expiration, limite de consultations, révocation et suppression côté client. Créez un accès avec le bouton +.",
        },
        sidebarInfo: {
          title: "Informations de la fiche",
          content:
            "Le panneau de droite résume l'identité du contact : nom, prénom, civilité, statut et fonction.",
        },
        sidebarDates: {
          title: "Historique de la fiche",
          content:
            "Dates de création et de dernière modification pour suivre l'ancienneté et les mises à jour du contact.",
        },
        heroActions: {
          title: "Actions sur le contact",
          content:
            "Éditez la fiche, copiez ou partagez les coordonnées, accédez à l'entreprise liée ou supprimez le contact depuis ce menu.",
        },
      },
    },
    toast: {
    ...
    share: {
      ...
      lines: { contact: "Contact", enterprise: "Entreprise", role: "Poste", phone: "Téléphone", email: "Email" },
    },
    clipboard: {
    ...
    ticketStatus: {
      open: "Ouvert", new: "Nouveau", pending: "En attente", in_progress: "En cours",
    ...
    eventTypes: {
      intervention: "Intervention", presentation: "Présentation", maintenance: "Maintenance",
      maintenance_preventive: "Maintenance préventive", mise_a_jour: "Mise à jour",
      integration_monitoring: "Intégration monitoring", other: "Autre",
    },
    proFeatures: {
    ...
    portal: {
      ...
      revokeModal: {
        ...
        bullets: [
          "Le contact ne pourra plus se connecter à l'espace client.",
          "Les identifiants associés seront définitivement supprimés.",
          "Vous pourrez recréer un accès portail ultérieurement si besoin.",
        ],
        cancel: "Annuler",
        revoke: "Révoquer l'accès",
        revoking: "Révocation…",
    ...
    deleteModal: {
      ...
      consequences: "Conséquences",
      bullets: [
        "La fiche contact et ses informations seront supprimées.",
        "L'accès portail associé sera révoqué s'il existe.",
  ...
  en: {
    ...
    defaultName: "Contact",
    status: { active: "Active", inactive: "Inactive", unknown: "Not specified" },
    ...
    fields: {
      lastName: "Last name", firstName: "First name", civility: "Title", status: "Status",
      role: "Job title", created: "Created", updated: "Updated",
    },
    table: {
      number: "No.", title: "Title", status: "Status", updated: "Updated",
      type: "Type", created: "Created", date: "Date",
    },
    ...
    guide: {
      steps: {
        hero: {
          ...
          content:
            "Find the name, status, job title, linked company and tags here. The company link opens the client record directly.",
        },
        ticketBookmarks: {
          title: "Open tickets",
          content:
            "Quickly access this contact's open or recent tickets. Create a new ticket or open the full support list.",
        },
        coordinates: {
          title: "Contact details",
          content:
            "Emails, phones and other contact methods. Click a row to call or send a message.",
        },
        activity: {
          title: "MSP activity",
          content:
            "View support history, service requests and scheduled events for this contact and their company.",
        },
        portal: {
          title: "Client portal",
          content:
            "Manage portal access: account creation, activation, password reset and login tracking.",
        },
        sharedAccess: {
          title: "Access sharing",
          content:
            "Share a password or temporary access with the contact on their portal · expiry, view limit, revocation and client-side deletion. Create an access with the + button.",
        },
        sidebarInfo: {
          title: "Record information",
          content:
            "The right panel summarizes identity: last name, first name, title, status and role.",
        },
        sidebarDates: {
          title: "Record history",
          content:
            "Creation and last update dates to track how long the contact has existed and when it was changed.",
        },
        heroActions: {
          title: "Contact actions",
          content:
            "Edit the record, copy or share details, open the linked company or delete the contact from this menu.",
        },
      },
    },
    toast: {
    ...
    share: {
      ...
      lines: { contact: "Contact", enterprise: "Company", role: "Job title", phone: "Phone", email: "Email" },
    },
    clipboard: {
    ...
    ticketStatus: {
      open: "Open", new: "New", pending: "Pending", in_progress: "In progress",
    ...
    eventTypes: {
      intervention: "Intervention", presentation: "Presentation", maintenance: "Maintenance",
      maintenance_preventive: "Preventive maintenance", mise_a_jour: "Update",
      integration_monitoring: "Monitoring integration", other: "Other",
    },
    proFeatures: {
    ...
    portal: {
      ...
      revokeModal: {
        ...
        bullets: [
          "The contact will no longer be able to sign in to the client space.",
          "Associated credentials will be permanently deleted.",
          "You can recreate portal access later if needed.",
        ],
        cancel: "Cancel",
        revoke: "Revoke access",
        revoking: "Revoking…",
    ...
    deleteModal: {
      ...
      consequences: "Consequences",
      bullets: [
        "The contact record and its information will be deleted.",
        "Associated portal access will be revoked if it exists.",
  ...
  de: {
    ...
    defaultName: "Kontakt",
    status: { active: "Aktiv", inactive: "Inaktiv", unknown: "Nicht angegeben" },
    ...
    fields: {
      lastName: "Nachname", firstName: "Vorname", civility: "Anrede", status: "Status",
      role: "Funktion", created: "Erstellt", updated: "Geändert",
    },
    table: { number: "Nr.", title: "Titel", status: "Status", updated: "Aktualisiert", type: "Typ", created: "Erstellt", date: "Datum" },
    ...
    guide: {
      steps: {
        ...
        sharedAccess: {
          ...
          content:
            "Teilen Sie ein Passwort oder einen temporären Zugriff mit dem Kontakt im Portal · Ablauf, Ansichtslimit, Widerruf und clientseitige Löschung. Erstellen Sie einen Zugriff mit der +-Schaltfläche.",
        },
        sidebarInfo: {
    ...
    toast: {
      tagAdded: "Tag hinzugefügt", tagAddError: "Fehler beim Hinzufügen des Tags",
      tagRemoved: "Tag entfernt", tagRemoveError: "Fehler beim Entfernen des Tags",
      clientsLoadError: "Unternehmensliste konnte nicht geladen werden",
      cardCopied: "Kontaktdatensatz kopiert", cardCopyError: "Kontaktdatensatz konnte nicht kopiert werden",
      deleted: "Kontakt gelöscht.", deleteError: "Kontakt konnte nicht gelöscht werden.",
      createTicketNeedEnterprise: "Kontakt mit Unternehmen verknüpfen, um ein Ticket zu erstellen.",
    },
    share: {
      unavailable: "Teilen in diesem Browser nicht verfügbar", cancelled: "Teilen abgebrochen",
      title: "Kontaktdatensatz · {name}",
      lines: { contact: "Kontakt", enterprise: "Unternehmen", role: "Funktion", phone: "Telefon", email: "E-Mail" },
    },
    clipboard: { unavailable: "{label} nicht verfügbar", copied: "{label} kopiert", copyFailed: "{label} konnte nicht kopiert werden" },
    ticketStatus: {
      open: "Offen", new: "Neu", pending: "Ausstehend", in_progress: "In Bearbeitung",
      resolved: "Gelöst", closed: "Geschlossen",
    },
    prestationCategories: {
      "prestation-enlevement": "Abholung", "prestation-expedition": "Versand", "prestation-formation": "Schulung",
      "prestation-intervention-distante": "Remote-Einsatz", "prestation-intervention-site": "Vor-Ort-Einsatz",
      "prestation-production": "Produktion", "prestation-etude-avant-vente": "Vorverkaufsstudie",
    },
    eventTypes: {
      intervention: "Einsatz", presentation: "Präsentation", maintenance: "Wartung",
      maintenance_preventive: "Präventive Wartung", mise_a_jour: "Update",
      integration_monitoring: "Monitoring-Integration", other: "Sonstiges",
    },
    proFeatures: { prestations: "Leistungen", planning: "Unternehmensplanung", prestationTickets: "Leistungs-Tickets" },
    bookmarks: {
      ariaLabel: "Support-Tickets des Kontakts", open: "Offen", closed: "Geschlossen",
      empty: "Keine Support-Tickets für diesen Kontakt", noOpen: "Keine offenen Tickets",
      noClosed: "Keine kürzlich geschlossenen Tickets", viewAll: "Alle Tickets anzeigen",
      createTicket: "Ticket erstellen", createTicketNeedEnterprise: "Unternehmen erforderlich",
      untitled: "Ohne Titel", ticketFallback: "Ticket", noCategory: "Keine Kategorie",
    ...
    portal: {
      heroTitle: "Kundenbereich", heroDesc: "Anmeldung am Unternehmens-Dashboard als dieser Kontakt.",
      statusActive: "Aktiv", statusInactive: "Deaktiviert", statusNone: "Kein Zugang",
      usageHint: "{active}/{max} aktive Portalzugänge (Community)", limitReached: "- Limit erreicht",
      ...
      loginEmailLabel: "Anmelde-E-Mail", lastLoginLabel: "Letzte Anmeldung", never: "Nie",
      toggleTitle: "Dashboard-Zugang", toggleActive: "Kontakt kann sich am Kundenbereich anmelden.",
      toggleInactive: "Zugang ausgesetzt ohne Konto zu löschen.", toggleAria: "Dashboard-Zugang umschalten",
      resetPassword: "Passwort zurücksetzen", impersonate: "Übernehmen",
      impersonateTitle: "Kundenportal mit diesem Konto anzeigen", revoke: "Zugang widerrufen",
      emptyTitle: "Kein Portalzugang", emptyDesc: "Konto erstellen, damit {email} sich anmelden kann.",
      createAccess: "Portalzugang erstellen", limitTooltip: "Community-Limit: max. {max} aktive Zugänge",
      limitWarn: "Community-Limit: max. {max} Portal-Konten. Upgrade auf Veritas Pro.",
      contactFallback: "dieser Kontakt", loginVia: "· Anmeldung über",
      toast: {
        enabled: "Portalzugang aktiviert", disabled: "Portalzugang deaktiviert", created: "Portal-Konto erstellt",
        passwordUpdated: "Passwort aktualisiert", deleted: "Portal-Konto gelöscht",
        impersonationError: "Impersonation konnte nicht gestartet werden.",
      },
      passwordModal: {
        eyebrow: "MSP-Kundenportal", createTitle: "Portalzugang erstellen", resetTitle: "Passwort zurücksetzen",
        createSubtitle: "Ein Kundenbereich-Konto wird für diesen Kontakt erstellt.",
        resetSubtitle: "Neues Anmeldepasswort festlegen.", createSubmit: "Zugang erstellen",
        resetSubmit: "Passwort speichern", passwordLabel: "Passwort", confirmLabel: "Bestätigung",
        passwordPlaceholder: "Mindestens 6 Zeichen", confirmPlaceholder: "Passwort wiederholen",
        showPasswords: "Passwörter anzeigen", footerHint: "Mindestens 6 Zeichen",
        cancel: "Abbrechen", saving: "Speichern…", close: "Schließen",
        passwordTooShort: "Passwort muss mindestens 6 Zeichen haben",
        passwordMismatch: "Passwörter stimmen nicht überein", defaultName: "Kontakt",
      },
      revokeModal: {
        title: "Portalzugang widerrufen", subtitle: "Anmeldekonto wird gelöscht. CRM-Datensatz bleibt.",
        accountLine: "Konto: {email}", consequences: "Folgen",
        bullets: ["Keine Anmeldung mehr am Kundenbereich.", "Zugangsdaten werden gelöscht.", "Zugang kann später neu erstellt werden."],
        cancel: "Abbrechen", revoke: "Zugang widerrufen", revoking: "Widerruf…", close: "Schließen", defaultName: "Kontakt",
      },
      impersonation: { title: "Kundenportal wird geöffnet", signingInAs: "Anmeldung als", cancel: "Abbrechen", contactFallback: "dieser Kontakt" },
    },
    relative: { justNow: "gerade eben", minutesAgo: "vor {count} Min.", hoursAgo: "vor {count} Std.", daysAgo: "vor {count} T." },
    deleteModal: {
      title: "Kontakt löschen", subtitle: "Diese Aktion ist endgültig.",
      consequences: "Folgen",
      bullets: ["Kontaktdatensatz wird gelöscht.", "Portalzugang wird widerrufen.", "Nicht wiederherstellbar."],
      confirm: "Endgültig löschen", deleting: "Löschen…", cancel: "Abbrechen", close: "Schließen", defaultName: "dieser Kontakt",
    },
  },
  it: {
    ...
    status: { active: "Attivo", inactive: "Inattivo", unknown: "Non specificato" },
    ...
    fields: {
      lastName: "Cognome", firstName: "Nome", civility: "Titolo", status: "Stato",
      role: "Ruolo", created: "Creato il", updated: "Modificato il",
    },
    table: { number: "N°", title: "Titolo", status: "Stato", updated: "Aggiornato", type: "Tipo", created: "Creato", date: "Data" },
    ...
    guide: {
      steps: {
        ...
        sharedAccess: {
          ...
          content:
            "Condividi una password o un accesso temporaneo con il contatto sul portale · scadenza, limite visualizzazioni, revoca e eliminazione lato cliente. Crea un accesso con il pulsante +.",
        },
        sidebarInfo: {
    ...
    toast: {
      tagAdded: "Etichetta aggiunta", tagAddError: "Errore aggiunta etichetta",
      tagRemoved: "Etichetta rimossa", tagRemoveError: "Errore rimozione etichetta",
      clientsLoadError: "Impossibile caricare elenco aziende",
      cardCopied: "Scheda contatto copiata", cardCopyError: "Impossibile copiare la scheda",
      deleted: "Contatto eliminato.", deleteError: "Impossibile eliminare il contatto.",
      createTicketNeedEnterprise: "Collega il contatto a un'azienda per creare un ticket.",
    },
    share: {
      unavailable: "Condivisione non disponibile", cancelled: "Condivisione annullata",
      title: "Scheda contatto · {name}",
      lines: { contact: "Contatto", enterprise: "Azienda", role: "Ruolo", phone: "Telefono", email: "Email" },
    },
    clipboard: { unavailable: "{label} non disponibile", copied: "{label} copiato", copyFailed: "Impossibile copiare {label}" },
    ticketStatus: {
      open: "Aperto", new: "Nuovo", pending: "In attesa", in_progress: "In corso",
      resolved: "Risolto", closed: "Chiuso",
    },
    prestationCategories: {
      "prestation-enlevement": "Ritiro", "prestation-expedition": "Spedizione", "prestation-formation": "Formazione",
      "prestation-intervention-distante": "Intervento remoto", "prestation-intervention-site": "Intervento in sede",
      "prestation-production": "Produzione", "prestation-etude-avant-vente": "Studio pre-vendita",
    },
    eventTypes: {
      intervention: "Intervento", presentation: "Presentazione", maintenance: "Manutenzione",
      maintenance_preventive: "Manutenzione preventiva", mise_a_jour: "Aggiornamento",
      integration_monitoring: "Integrazione monitoring", other: "Altro",
    },
    proFeatures: { prestations: "Prestazioni", planning: "Pianificazione azienda", prestationTickets: "Ticket Prestazioni / Servizi" },
    bookmarks: {
      ariaLabel: "Ticket supporto del contatto", open: "Aperti", closed: "Chiusi",
      empty: "Nessun ticket supporto per questo contatto", noOpen: "Nessun ticket aperto",
      noClosed: "Nessun ticket chiuso di recente", viewAll: "Vedi tutti i ticket",
      createTicket: "Crea ticket", createTicketNeedEnterprise: "Azienda richiesta",
      untitled: "Senza titolo", ticketFallback: "Ticket", noCategory: "Senza categoria",
    ...
    portal: {
      heroTitle: "Spazio cliente", heroDesc: "Accesso alla dashboard azienda con l'identità di questo contatto.",
      statusActive: "Attivo", statusInactive: "Disattivato", statusNone: "Nessun accesso",
      usageHint: "{active}/{max} accessi portale attivi (Community)", limitReached: "- limite raggiunto",
      ...
      loginEmailLabel: "E-mail di accesso", lastLoginLabel: "Ultimo accesso", never: "Mai",
      toggleTitle: "Accesso dashboard", toggleActive: "Il contatto può accedere allo spazio cliente.",
      toggleInactive: "Accesso sospeso senza eliminare l'account.", toggleAria: "Attiva/disattiva accesso dashboard",
      resetPassword: "Reimposta password", impersonate: "Prendi controllo",
      impersonateTitle: "Visualizza portale con account del contatto", revoke: "Revoca accesso",
      emptyTitle: "Nessun accesso portale", emptyDesc: "Crea un account per {email}.",
      createAccess: "Crea accesso portale", limitTooltip: "Limite Community: max {max} accessi attivi",
      limitWarn: "Limite Community: max {max} account portale. Passa a Veritas Pro.",
      contactFallback: "questo contatto", loginVia: "· accesso via",
      toast: {
        enabled: "Accesso portale attivato", disabled: "Accesso portale disattivato", created: "Account portale creato",
        passwordUpdated: "Password aggiornata", deleted: "Account portale eliminato",
        impersonationError: "Impossibile avviare impersonation.",
      },
      passwordModal: {
        eyebrow: "Portale cliente MSP", createTitle: "Crea accesso portale", resetTitle: "Reimposta password",
        createSubtitle: "Verrà creato un account spazio cliente.", resetSubtitle: "Imposta nuova password.",
        createSubmit: "Crea accesso", resetSubmit: "Salva password", passwordLabel: "Password", confirmLabel: "Conferma",
        passwordPlaceholder: "Minimo 6 caratteri", confirmPlaceholder: "Ripeti password",
        showPasswords: "Mostra password", footerHint: "Minimo 6 caratteri",
        cancel: "Annulla", saving: "Salvataggio…", close: "Chiudi",
        passwordTooShort: "Password di almeno 6 caratteri", passwordMismatch: "Le password non coincidono", defaultName: "Contatto",
      },
      revokeModal: {
        title: "Revoca accesso portale", subtitle: "Account eliminato. Scheda CRM conservata.",
        accountLine: "Account: {email}", consequences: "Conseguenze",
        bullets: ["Nessun accesso allo spazio cliente.", "Credenziali eliminate.", "Accesso ricreabile in seguito."],
        cancel: "Annulla", revoke: "Revoca accesso", revoking: "Revoca…", close: "Chiudi", defaultName: "Contatto",
      },
      impersonation: { title: "Apertura portale cliente", signingInAs: "Accesso come", cancel: "Annulla", contactFallback: "questo contatto" },
    },
    relative: { justNow: "adesso", minutesAgo: "{count} min fa", hoursAgo: "{count} h fa", daysAgo: "{count} g fa" },
    deleteModal: {
      title: "Elimina contatto", subtitle: "Azione definitiva e irreversibile.",
      ...
      confirm: "Elimina definitivamente", deleting: "Eliminazione…", cancel: "Annulla", close: "Chiudi", defaultName: "questo contatto",
    },
  },
  es: {
    ...
    status: { active: "Activo", inactive: "Inactivo", unknown: "No especificado" },
    ...
    fields: {
      lastName: "Apellidos", firstName: "Nombre", civility: "Tratamiento", status: "Estado",
      role: "Puesto", created: "Creado", updated: "Modificado",
    },
    table: { number: "N°", title: "Título", status: "Estado", updated: "Actualizado", type: "Tipo", created: "Creado", date: "Fecha" },
    ...
    guide: {
      steps: {
        ...
        sharedAccess: {
          ...
          content:
            "Comparta una contraseña o un acceso temporal con el contacto en su portal · caducidad, límite de consultas, revocación y eliminación del lado del cliente. Cree un acceso con el botón +.",
        },
        sidebarInfo: {
    ...
    toast: {
      tagAdded: "Etiqueta añadida", tagAddError: "Error al añadir etiqueta",
      tagRemoved: "Etiqueta eliminada", tagRemoveError: "Error al eliminar etiqueta",
      clientsLoadError: "No se pudo cargar la lista de empresas",
      cardCopied: "Ficha contacto copiada", cardCopyError: "No se pudo copiar la ficha",
      deleted: "Contacto eliminado.", deleteError: "No se pudo eliminar el contacto.",
      createTicketNeedEnterprise: "Vincule el contacto a una empresa para crear un ticket.",
    },
    share: {
      unavailable: "Compartir no disponible en este navegador", cancelled: "Compartir cancelado",
      title: "Ficha contacto · {name}",
      lines: { contact: "Contacto", enterprise: "Empresa", role: "Puesto", phone: "Teléfono", email: "Email" },
    },
    clipboard: { unavailable: "{label} no disponible", copied: "{label} copiado", copyFailed: "No se pudo copiar {label}" },
    ticketStatus: {
      open: "Abierto", new: "Nuevo", pending: "Pendiente", in_progress: "En curso",
      resolved: "Resuelto", closed: "Cerrado",
    },
    prestationCategories: {
      "prestation-enlevement": "Recogida", "prestation-expedition": "Envío", "prestation-formation": "Formación",
      "prestation-intervention-distante": "Intervención remota", "prestation-intervention-site": "Intervención in situ",
      "prestation-production": "Producción", "prestation-etude-avant-vente": "Estudio previo a venta",
    },
    eventTypes: {
      intervention: "Intervención", presentation: "Presentación", maintenance: "Mantenimiento",
      maintenance_preventive: "Mantenimiento preventivo", mise_a_jour: "Actualización",
      integration_monitoring: "Integración monitoring", other: "Otro",
    },
    proFeatures: { prestations: "Prestaciones", planning: "Planificación empresa", prestationTickets: "Tickets Prestaciones / Servicios" },
    bookmarks: {
      ariaLabel: "Tickets Soporte del contacto", open: "Abiertos", closed: "Cerrados",
      empty: "Ningún ticket de soporte para este contacto", noOpen: "Ningún ticket abierto",
      noClosed: "Ningún ticket cerrado reciente", viewAll: "Ver todos los tickets",
      createTicket: "Crear ticket", createTicketNeedEnterprise: "Empresa requerida",
      untitled: "Sin título", ticketFallback: "Ticket", noCategory: "Sin categoría",
    ...
    portal: {
      heroTitle: "Espacio cliente", heroDesc: "Acceso al panel de la empresa con la identidad de este contacto.",
      statusActive: "Activo", statusInactive: "Desactivado", statusNone: "Sin acceso",
      usageHint: "{active}/{max} accesos portal activos (Community)", limitReached: "- límite alcanzado",
      ...
      loginEmailLabel: "E-mail de acceso", lastLoginLabel: "Último acceso", never: "Nunca",
      toggleTitle: "Acceso al panel", toggleActive: "El contacto puede acceder al espacio cliente.",
      toggleInactive: "Acceso suspendido sin eliminar la cuenta.", toggleAria: "Activar/desactivar acceso al panel",
      resetPassword: "Restablecer contraseña", impersonate: "Tomar control",
      impersonateTitle: "Ver portal con la cuenta del contacto", revoke: "Revocar acceso",
      emptyTitle: "Sin acceso portal", emptyDesc: "Cree una cuenta para {email}.",
      createAccess: "Crear acceso portal", limitTooltip: "Límite Community: máx. {max} accesos activos",
      limitWarn: "Límite Community: máx. {max} cuentas portal. Pase a Veritas Pro.",
      contactFallback: "este contacto", loginVia: "· acceso vía",
      toast: {
        enabled: "Acceso portal activado", disabled: "Acceso portal desactivado", created: "Cuenta portal creada",
        passwordUpdated: "Contraseña actualizada", deleted: "Cuenta portal eliminada",
        impersonationError: "No se pudo iniciar la impersonación.",
      },
      passwordModal: {
        eyebrow: "Portal cliente MSP", createTitle: "Crear acceso portal", resetTitle: "Restablecer contraseña",
        createSubtitle: "Se creará una cuenta espacio cliente.", resetSubtitle: "Defina nueva contraseña.",
        createSubmit: "Crear acceso", resetSubmit: "Guardar contraseña", passwordLabel: "Contraseña", confirmLabel: "Confirmación",
        passwordPlaceholder: "Mínimo 6 caracteres", confirmPlaceholder: "Repita la contraseña",
        showPasswords: "Mostrar contraseñas", footerHint: "Mínimo 6 caracteres",
        cancel: "Cancelar", saving: "Guardando…", close: "Cerrar",
        passwordTooShort: "La contraseña debe tener al menos 6 caracteres", passwordMismatch: "Las contraseñas no coinciden", defaultName: "Contacto",
      },
      revokeModal: {
        title: "Revocar acceso portal", subtitle: "Se eliminará la cuenta. Se conserva la ficha CRM.",
        accountLine: "Cuenta: {email}", consequences: "Consecuencias",
        bullets: ["Sin acceso al espacio cliente.", "Credenciales eliminadas.", "Acceso recreable más tarde."],
        cancel: "Cancelar", revoke: "Revocar acceso", revoking: "Revocando…", close: "Cerrar", defaultName: "Contacto",
      },
      impersonation: { title: "Abriendo portal cliente", signingInAs: "Acceso como", cancel: "Cancelar", contactFallback: "este contacto" },
    },
    relative: { justNow: "ahora", minutesAgo: "hace {count} min", hoursAgo: "hace {count} h", daysAgo: "hace {count} d" },
    deleteModal: {
      title: "Eliminar contacto", subtitle: "Acción definitiva e irreversible.",
      consequences: "Consecuencias",
      bullets: ["Se eliminará la ficha contacto.", "Se revocará el acceso al portal.", "Operación irreversible."],
      confirm: "Eliminar definitivamente", deleting: "Eliminando…", cancel: "Cancelar", close: "Cerrar", defaultName: "este contacto",
    },
  },
};
...
export function getContactStatusLocalized(statut, locale) {
  ...
  if (value.includes("inact")) return { status: "suspended", label: labels.inactive };
  if (value.includes("act")) return { status: "active", label: labels.active };
  return { status: "unknown", label: labels.unknown };
}
...
export function formatContactRelativeTime(value, locale, formatDateTime) {
  ...
  if (diffMin < 60) return interpolate(rel.minutesAgo, { count: String(diffMin) });
  const diffH = Math.floor(diffMin / 60);
  if (diffH < 24) return interpolate(rel.hoursAgo, { count: String(diffH) });
  const diffD = Math.floor(diffH / 24);
  if (diffD < 7) return interpolate(rel.daysAgo, { count: String(diffD) });
