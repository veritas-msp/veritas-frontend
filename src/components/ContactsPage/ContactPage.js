...
export default function ContactPage({
  ...
  const handleExportCsv = () => {
    ...
    filteredAndSortedContacts.forEach(contact => {
      ...
      rows.push([contact.nom || "", contact.prenom || "", contact.statut || "", formatClientDisplay(rawClientLabel), contact.poste || "", contact.email || "", contact.telephone || ""]);
    });
  ...
  return <div className={`${mspStyles.mspPage} ${layout.page} msp-page-grid`}>
      <div className={mspStyles.mspLayout}>
        <div className={mspStyles.mspMain}>
          <MspPageHero className={layout.compactHero} brandMarkClassName={layout.compactBrandMark} eyebrow={pageCopy.eyebrow} title={pageCopy.pageTitle} subtitle={loading ? pageCopy.loadingPortfolio : pageCopy.formatSubtitle(filteredAndSortedContacts.length, portfolioTotal)} icon="mdi:account-group-outline" actions={<>
            ...
            <div className={layout.listArea}>
              <div className={layout.dataTableWrap}>
                <table className={layout.dataTable}>
                  <thead>
                    <tr>
                      <th aria-sort={sortBy === "nom" ? sortOrder === "asc" ? "ascending" : "descending" : "none"}>
                        <ThSort label={pageCopy.table.contact} col="nom" />
                      </th>
                      <th aria-sort={sortBy === "client" ? sortOrder === "asc" ? "ascending" : "descending" : "none"}>
                        <ThSort label={pageCopy.table.enterprise} col="client" />
                      </th>
                      <th aria-sort={sortBy === "poste" ? sortOrder === "asc" ? "ascending" : "descending" : "none"}>
                        <ThSort label={pageCopy.table.role} col="poste" />
                      </th>
                      <th aria-sort={sortBy === "email" ? sortOrder === "asc" ? "ascending" : "descending" : "none"}>
                        <ThSort label={pageCopy.table.email} col="email" />
                      </th>
                      <th aria-sort={sortBy === "telephone" ? sortOrder === "asc" ? "ascending" : "descending" : "none"}>
                        <ThSort label={pageCopy.table.phone} col="telephone" />
                      </th>
                      <th>{pageCopy.table.portal}</th>
                    ...
                    {paginatedContacts.map(contact => {
                      ...
                      return <tr key={contact.id} className={layout.dataTableRow} onClick={() => openContact(contact)} onAuxClick={e => {
                        ...
                        if (e.key === "Enter" || e.key === " ") {
                          ...
                          <td className={layout.colCompany}>
                            <div className={layout.tableIdentity}>
                              <div className={layout.avatar}>
                                <span className={layout.avatarRing} style={{
                                  borderColor: contactStatus.color
                                }} />
                                {getContactInitials(contact)}
                              </div>
                              <div className={layout.tableIdentityText}>
                                <SmartTooltip content={getContactDisplayName(contact)} as="span" className={layout.clientNameInner}>
                                ...
                                {contactSexe ? <span className={styles.contactMetaLine}>
                                    <Icon icon={getContactSexeIcon(contactSexe)} aria-hidden />
                                    {getContactSexeLabelLocalized(contactSexe, locale)}
                                  </span> : null}
                              </div>
                            </div>
                          </td>
                          <td className={layout.colMuted}>{clientDisplay}</td>
                          <td className={layout.colMuted}>
                          ...
                          <td onClick={e => e.stopPropagation()}>
                            {contact.email ? <div className={styles.cellWithAction}>
                          ...
                          <td className={styles.portalCell} onClick={e => e.stopPropagation()}>
