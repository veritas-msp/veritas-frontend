  ...
  return createPortal(
    <div className={styles.overlay} onClick={onClose} role="presentation">
      <div
        ...
        role="alertdialog"
        aria-modal="true"
        aria-labelledby="contact-portal-revoke-title"
        aria-describedby="contact-portal-revoke-desc"
      >
        ...
        <div className={styles.body}>
          ...
          {loginEmail && (
            ...
            >
              {interpolate(modalCopy.accountLine, { email: loginEmail })}
            </p>
          )}
          <div className={styles.warningBox}>
            <p className={styles.warningTitle}>{modalCopy.consequences}</p>
            <ul className={styles.warningList}>
              {modalCopy.bullets.map((bullet) => (
