...
export default function ClientVaultSecretDeleteModal({
  ...
  return createPortal(
    <div className={`${styles.overlay} ${formStyles.overlayStacked}`} onClick={onClose} role="presentation">
      <div
        className={styles.shell}
        onClick={(e) => e.stopPropagation()}
        role="alertdialog"
        aria-modal="true"
        aria-labelledby="client-vault-secret-delete-title"
        aria-describedby="client-vault-secret-delete-desc"
      >
