...
export function getPortalTicketActionRequiredBadge(ticket, copy) {
  ...
  if (isPortalTicketPendingValidation(ticket)) {
    return { label: "Validation required" };
  }
...
const PORTAL_PRIORITY_ORDER = { low: 1, normal: 2, high: 3, urgent: 4 };
