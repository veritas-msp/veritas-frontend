...
export default function ClientDevicesPage() {
  ...
  const pageTabs = useMemo(
    () => [
      { key: "overview", label: t.tabOverview, icon: "mdi:chart-box-outline", tone: "blue" },
      { key: "devices", label: t.tabDevices, icon: "mdi:devices", tone: "violet" },
    ],
  ...
  const { stats, infrastructure, computers } = data;
          ...
          <>
            ...
            {activeTab === "overview" ? (
              ...
              <ClientDevicesListTab
                mappedComputers={mappedComputers}
                rawComputers={computers || []}
