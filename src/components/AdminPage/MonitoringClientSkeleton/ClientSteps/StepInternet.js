                            ...
                            <div style={{
                              ...
                              <div style={{
                                ...
                                <div>
                                  ...
                                  <select
                                    value={connection.categorie}
                                    onChange={(e) => updateConnection(i, 'categorie', e.target.value)}
                                    style={{
                                      width: '100%',
                                ...
                                <div>
                                  ...
                                  <input
                                    type="text"
                                    value={connection.fournisseur}
                                    onChange={(e) => updateConnection(i, 'fournisseur', e.target.value)}
                                    placeholder="Ex: Orange, SFR..."
                                    style={{
                                      width: '100%',
                                      padding: '0.6rem 0.75rem',
                                      border: '1px solid #e0e0e0',
                                ...
                                <div>
                                  ...
                                  <select
                                    value={connection.debit}
                                    onChange={(e) => updateConnection(i, 'debit', e.target.value)}
                                    style={{
                                      width: '100%',
                                      padding: '0.6rem 0.75rem',
                                      border: '1px solid #e0e0e0',
                                ...
                                <div>
                                  ...
                                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                                    <input
                                      type="text"
                                      value={connection.ip}
                                      onChange={(e) => updateConnection(i, 'ip', e.target.value)}
                                      placeholder="Ex: 192.168.1.1"
                                      disabled={connection.ipNonFixe}
                                      style={{
                                        flex: 1,
                                        padding: '0.6rem 0.75rem',
                                        border: '1px solid #e0e0e0',
                                        borderRadius: '8px',
                                        background: connection.ipNonFixe ? '#f3f4f6' : '#ffffff',
                                        color: connection.ipNonFixe ? '#6b7280' : '#1a1a1a',
                                        fontSize: '0.9rem',
                                        opacity: connection.ipNonFixe ? 0.7 : 1
                                      }}
                                    />
                                    <button
                                      type="button"
                                      onClick={() => {
                                        const newValue = !connection.ipNonFixe;
                                        const lastFixedIp = connection._lastFixedIp ?? connection.ip ?? '';
                                        updateConnection(i, '_lastFixedIp', lastFixedIp);
                                        updateConnection(i, 'ipNonFixe', newValue);
                                        updateConnection(i, 'ip', newValue ? 'Non fixe' : lastFixedIp);
                                      }}
                                      style={{
                                        padding: '0.6rem 1rem',
                                        borderRadius: '8px',
                                        border: `1px solid ${connection.ipNonFixe ? '#3b82f6' : '#e0e0e0'}`,
                                        background: connection.ipNonFixe ? '#3b82f6' : '#ffffff',
                                        color: connection.ipNonFixe ? '#ffffff' : '#1a1a1a',
                                        cursor: 'pointer',
                                        fontSize: '0.875rem',
                                        fontWeight: 500,
                                        whiteSpace: 'nowrap',
          ...
          >
            <div className={adminStyles.modalHeader}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <Icon icon="mdi:web" className={adminStyles.modalIcon} style={{ color: '#3b82f6' }} />
                <h3>Ajouter une connexion Internet</h3>
              </div>
              <button
            ...
            <div className={adminStyles.modalBody}>
              <div style={{
                ...
                {[
                  { label: "Fibre", icon: "streamline-ultimate:fiber-access-1" },
                  { label: "ADSL", icon: "mdi:ethernet-cable" },
                  { label: "4G", icon: "material-symbols:4g-mobiledata-badge" },
                  { label: "5G", icon: "material-symbols:5g-mobiledata-badge" },
                  { label: "Satellite", icon: "tabler:satellite" }
                ].map(({ label, icon }) => (
                  <button
                    key={label}
                    onClick={() => addConnection(label)}
                    style={{
                      width: '100%',
                      border: '1px solid #e0e0e0',
                      borderRadius: '10px',
