...
export function ConfirmModal({
  ...
  const copy = useCommonCopy();
  return <Modal open={open} onClose={onClose} title={title} icon={icon} width={width} footer={<ModalFooter onCancel={onClose} onConfirm={onConfirm} confirmLabel={confirmLabel || copy.confirm} confirmVariant={confirmVariant} confirmLoading={confirmLoading} />}>
...
export function Modal({
  ...
  const copy = useCommonCopy();
  if (!open) return null;
  return createPortal(<div className={s.modalOverlay} onClick={onClose} role="presentation">
...
export function FormGrid({
  ...
  return <div className={s.formGrid} style={{
