...
const ADMIN_PANEL_COPY = {
  fr: {
    ...
    items: {
      ...
      permissions: {
        label: "Permissions",
        description: "Actions autorisées par profil (créer, modifier, supprimer…)"
      },
      teams: {
        label: "Équipes",
      ...
      sla: {
        label: "SLA",
        description: "Délais et plages horaires par client"
      },
      "nav-client-config": {
      ...
      "sales-forms": {
        label: "Formulaires ventes",
        description: "Champs des tickets prestation"
      },
      "notifications-inapp": {
      ...
      notifications: {
        label: "Événements & webhooks",
        description: "Alertes automatiques et envoi externe"
      },
      maintenance: {
  ...
  en: {
    ...
    items: {
      ...
      permissions: {
        label: "Permissions",
        description: "Allowed actions per profile (create, edit, delete…)"
      },
      teams: {
        label: "Teams",
      ...
      sla: {
        label: "SLA",
        description: "Deadlines and time windows per client"
      },
      "nav-client-config": {
      ...
      "sales-forms": {
        label: "Sales forms",
        description: "Fields for service tickets"
      },
      "notifications-inapp": {
      ...
      notifications: {
        ...
        description: "Automatic alerts and external delivery"
      },
      maintenance: {
  ...
  de: {
    ...
    items: {
      ...
      permissions: {
        ...
        description: "Erlaubte Aktionen pro Profil (erstellen, bearbeiten, löschen…)"
      },
      teams: {
        label: "Teams",
      ...
      sla: {
        label: "SLA",
        description: "Fristen und Zeitfenster pro Kunde"
      },
      "nav-client-config": {
      ...
      "sales-forms": {
        label: "Vertriebsformulare",
        description: "Felder für Leistungstickets"
      },
      "notifications-inapp": {
      ...
      notifications: {
        label: "Ereignisse & Webhooks",
        description: "Automatische Alerts und externe Zustellung"
      },
      maintenance: {
  ...
  it: {
    ...
    items: {
      ...
      permissions: {
        label: "Permessi",
        description: "Azioni consentite per profilo (creare, modificare, eliminare…)"
      },
      teams: {
        label: "Team",
      ...
      sla: {
        label: "SLA",
        description: "Scadenze e fasce orarie per cliente"
      },
      "nav-client-config": {
      ...
      "sales-forms": {
        label: "Moduli vendite",
        description: "Campi dei ticket prestazione"
      },
      "notifications-inapp": {
      ...
      notifications: {
        label: "Eventi e webhook",
        description: "Alert automatici e invio esterno"
      },
      maintenance: {
  ...
  es: {
    ...
    items: {
      ...
      permissions: {
        label: "Permisos",
        description: "Acciones permitidas por perfil (crear, editar, eliminar…)"
      },
      teams: {
        label: "Equipos",
      ...
      sla: {
        label: "SLA",
        description: "Plazos y franjas horarias por cliente"
      },
      "nav-client-config": {
      ...
      "sales-forms": {
        label: "Formularios de ventas",
        description: "Campos de tickets de prestación"
      },
      "notifications-inapp": {
      ...
      notifications: {
        label: "Eventos y webhooks",
        description: "Alertas automáticas y envío externo"
      },
      maintenance: {
