...
const ADMIN_IN_APP_NOTIFICATIONS_COPY = {
  fr: {
    ...
    fields: {
      ticket_commented: {
        notifyAssignees: { label: "Assignés", hint: "Agents assignés au ticket" },
        notifyWatchers: { label: "Followers", hint: "Agents qui suivent le ticket" },
      ...
      ticket_created: {
        notifyAssignees: { label: "Notifier les assignés", hint: "Dès la création du ticket" },
      },
      ticket_updated: {
        notifyAssignees: { label: "Notifier les assignés", hint: "Sur toute modification" },
      },
      ticket_resolved: {
        notifyAssignees: { label: "Assignés", hint: "Agents assignés au ticket" },
        notifyWatchers: { label: "Followers", hint: "Agents qui suivent le ticket" },
      ...
      ticket_satisfaction: {
        notifyAssignees: { label: "Assignés", hint: "Agent assigné au ticket" },
        notifyWatchers: { label: "Followers", hint: "Agents qui suivent le ticket" },
      },
    },
    footer: { hint: "Réglages globaux · test envoyé à votre compte uniquement." },
    test: {
      label: "Test",
    ...
    save: { saving: "Enregistrement…", button: "Enregistrer" },
    toast: {
  ...
  en: {
    ...
    fields: {
      ticket_commented: {
        notifyAssignees: { label: "Assignees", hint: "Agents assigned to the ticket" },
        notifyWatchers: { label: "Followers", hint: "Agents following the ticket" },
        excludeInternalComments: {
      ...
      ticket_created: {
        notifyAssignees: { label: "Notify assignees", hint: "As soon as the ticket is created" },
      },
      ticket_updated: {
        notifyAssignees: { label: "Notify assignees", hint: "On any update" },
      },
      ticket_resolved: {
        notifyAssignees: { label: "Assignees", hint: "Agents assigned to the ticket" },
        notifyWatchers: { label: "Followers", hint: "Agents following the ticket" },
      ...
      ticket_satisfaction: {
        notifyAssignees: { label: "Assignees", hint: "Agent assigned to the ticket" },
        notifyWatchers: { label: "Followers", hint: "Agents following the ticket" },
      },
    },
    footer: { hint: "Global settings · test sent to your account only." },
    test: {
      label: "Test",
    ...
    save: { saving: "Saving…", button: "Save" },
    toast: {
  ...
  de: {
    ...
    fields: {
      ticket_commented: {
        notifyAssignees: { label: "Zuständige", hint: "Dem Ticket zugewiesene Agenten" },
        notifyWatchers: { label: "Follower", hint: "Agenten, die dem Ticket folgen" },
        excludeInternalComments: {
      ...
      ticket_created: {
        notifyAssignees: { label: "Zuständige benachrichtigen", hint: "Sobald das Ticket erstellt wird" },
      },
      ticket_updated: {
        notifyAssignees: { label: "Zuständige benachrichtigen", hint: "Bei jeder Änderung" },
      },
      ticket_resolved: {
        notifyAssignees: { label: "Zuständige", hint: "Dem Ticket zugewiesene Agenten" },
        notifyWatchers: { label: "Follower", hint: "Agenten, die dem Ticket folgen" },
      ...
      ticket_satisfaction: {
        notifyAssignees: { label: "Zuständige", hint: "Dem Ticket zugewiesener Agent" },
        notifyWatchers: { label: "Follower", hint: "Agenten, die dem Ticket folgen" },
      },
    },
    footer: { hint: "Globale Einstellungen · Test nur an Ihr Konto gesendet." },
    test: {
      label: "Test",
    ...
    save: { saving: "Speichern…", button: "Speichern" },
    toast: {
  ...
  it: {
    ...
    status: { enabled: "Attivo", disabled: "Disattivo" },
    eventsCard: {
    ...
    fields: {
      ticket_commented: {
        notifyAssignees: { label: "Assegnatari", hint: "Agenti assegnati al ticket" },
        notifyWatchers: { label: "Follower", hint: "Agenti che seguono il ticket" },
        excludeInternalComments: {
      ...
      ticket_created: {
        notifyAssignees: { label: "Avvisa gli assegnatari", hint: "Alla creazione del ticket" },
      },
      ticket_updated: {
        notifyAssignees: { label: "Avvisa gli assegnatari", hint: "Su ogni modifica" },
      },
      ticket_resolved: {
        notifyAssignees: { label: "Assegnatari", hint: "Agenti assegnati al ticket" },
        notifyWatchers: { label: "Follower", hint: "Agenti che seguono il ticket" },
      ...
      ticket_satisfaction: {
        notifyAssignees: { label: "Assegnatari", hint: "Agente assegnato al ticket" },
        notifyWatchers: { label: "Follower", hint: "Agenti che seguono il ticket" },
      },
    },
    footer: { hint: "Impostazioni globali · test inviato solo al tuo account." },
    test: {
      label: "Test",
    ...
    save: { saving: "Salvataggio…", button: "Salva" },
    toast: {
  ...
  es: {
    ...
    fields: {
      ticket_commented: {
        notifyAssignees: { label: "Asignados", hint: "Agentes asignados al ticket" },
        notifyWatchers: { label: "Seguidores", hint: "Agentes que siguen el ticket" },
        excludeInternalComments: {
      ...
      ticket_created: {
        notifyAssignees: { label: "Notificar asignados", hint: "Al crear el ticket" },
      },
      ticket_updated: {
        notifyAssignees: { label: "Notificar asignados", hint: "En cualquier actualización" },
      },
      ticket_resolved: {
        notifyAssignees: { label: "Asignados", hint: "Agentes asignados al ticket" },
        notifyWatchers: { label: "Seguidores", hint: "Agentes que siguen el ticket" },
      ...
      ticket_satisfaction: {
        notifyAssignees: { label: "Asignados", hint: "Agente asignado al ticket" },
        notifyWatchers: { label: "Seguidores", hint: "Agentes que siguen el ticket" },
      },
    },
    footer: { hint: "Ajustes globales · prueba enviada solo a su cuenta." },
    test: {
      label: "Prueba",
    ...
    save: { saving: "Guardando…", button: "Guardar" },
    toast: {
