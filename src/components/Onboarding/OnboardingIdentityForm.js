    ...
    <form className={styles.inlineForm} onSubmit={(e) => e.preventDefault()}>
      <div className={styles.inlineFormField}>
        ...
        <input
          ...
          value={general.app_organization_name}
          onChange={(e) => onChange({ app_organization_name: e.target.value })}
      ...
      <div className={styles.inlineFormField}>
        ...
        <select
          id="onboarding-org-size"
          className={styles.inlineFormSelect}
          value={general.app_organization_employee_range || ""}
          onChange={(e) => onChange({ app_organization_employee_range: e.target.value })}
          disabled={disabled}
        >
      ...
      <div className={styles.inlineFormField}>
        ...
        <input
          id="onboarding-org-address"
          type="text"
          className={styles.inlineFormInput}
          value={general.app_organization_address}
          onChange={(e) => onChange({ app_organization_address: e.target.value })}
      ...
      <div className={styles.inlineFormField}>
        ...
        <input
          id="onboarding-org-website"
          type="url"
          className={styles.inlineFormInput}
          value={general.app_organization_website}
          onChange={(e) => onChange({ app_organization_website: e.target.value })}
