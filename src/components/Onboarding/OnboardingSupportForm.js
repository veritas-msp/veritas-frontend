...
export default function OnboardingSupportForm({ labels, general, onChange, disabled }) {
  const { groups: timezoneGroups } = getTimezoneOptions(general.app_timezone);
  return (
    <form className={styles.inlineForm} onSubmit={(e) => e.preventDefault()}>
      <div className={styles.inlineFormRow}>
        <div className={styles.inlineFormField}>
          ...
          <input
            id="onboarding-org-email"
            type="email"
            className={styles.inlineFormInput}
            value={general.app_support_email}
            onChange={(e) => onChange({ app_support_email: e.target.value })}
        ...
        <div className={styles.inlineFormField}>
          ...
          <input
            id="onboarding-org-phone"
            type="tel"
            className={styles.inlineFormInput}
            value={general.app_support_phone}
            onChange={(e) => onChange({ app_support_phone: e.target.value })}
            placeholder={labels.supportPhonePlaceholder}
            maxLength={40}
            disabled={disabled}
          />
        </div>
      ...
      <div className={styles.inlineFormField}>
        ...
        <select
          id="onboarding-org-timezone"
          className={styles.inlineFormSelect}
          value={general.app_timezone}
