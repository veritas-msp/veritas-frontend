  ...
  return createPortal(
    <div className={layout.overlay} onClick={onClose} role="presentation">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="ticket-reminder-modal-title"
      >
          ...
          <div className={`${layout.content} ${styles.formContent}`}>
            <div className={exclusionStyles.ticketContextCard}>
              ...
              <div className={exclusionStyles.ticketContextText}>
                ...
                {requesterName ? (
                  <div className={exclusionStyles.ticketContextMeta}>
            ...
            <div className={layout.fieldGrid2}>
              <div className={layout.field}>
                ...
                <input
                  id="reminder-date"
                  type="date"
                  className={`${layout.input} ${styles.dateTimeInput}`}
                  value={form.date}
          ...
          <footer className={styles.footer}>
            <div className={styles.footerActions}>
              {isEditing ? (
                <button
                  type="button"
                  className={`${layout.ghostBtn} ${styles.footerBtn} ${styles.deleteBtn}`}
                  onClick={() => onDelete?.()}
                  disabled={saving || deleting}
                >
                  <FaTrash />
              ...
              <button
                type="button"
                className={`${layout.ghostBtn} ${styles.footerBtn}`}
                onClick={onClose}
                disabled={saving || deleting}
              >
                {copy.cancel}
              ...
              <button
                type="submit"
                className={`${layout.primaryBtn} ${styles.footerBtn} ${styles.footerBtnPrimary}`}
                disabled={saving || deleting}
              >
