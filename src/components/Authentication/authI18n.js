...
const AUTH_COPY = {
  fr: {
    views: {
      login: { title: "Connexion", sub: "Accédez à votre espace de gestion." },
      forgot: {
    ...
    panel: {
      agent: {
        ...
        features: [
          ...
          "Alertes & rapports en temps réel",
        ],
      },
      client: {
    ...
    accountToggle: { agent: "Agent MSP", client: "Espace client" },
    back: "← Retour",
    mfa: {
    ...
    outage: {
      ...
      lead:
        "Veritas est temporairement indisponible. Notre équipe technique travaille activement à la résolution du problème.",
  ...
  en: {
    views: {
      login: { title: "Sign in", sub: "Access your management workspace." },
      forgot: {
    ...
    accountToggle: { agent: "MSP Agent", client: "Client portal" },
    back: "← Back",
    mfa: {
    ...
    outage: {
      ...
      lead:
        "Veritas is temporarily unavailable. Our technical team is actively working to resolve the issue.",
  ...
  de: {
    views: {
      login: { title: "Anmeldung", sub: "Greifen Sie auf Ihren Verwaltungsbereich zu." },
      forgot: {
    ...
    accountToggle: { agent: "MSP-Agent", client: "Kundenportal" },
    back: "← Zurück",
    mfa: {
    ...
    outage: {
      title: "Wartung läuft",
      lead:
        "Veritas ist vorübergehend nicht verfügbar. Unser technisches Team arbeitet aktiv an der Behebung.",
  ...
  it: {
    views: {
      login: { title: "Accesso", sub: "Accedi al tuo spazio di gestione." },
      forgot: {
    ...
    accountToggle: { agent: "Agente MSP", client: "Portale clienti" },
    back: "← Indietro",
    mfa: {
      title: "Verifica MFA",
    ...
    outage: {
      ...
      lead:
        "Veritas è temporaneamente non disponibile. Il nostro team tecnico sta lavorando per risolvere il problema.",
  ...
  es: {
    views: {
      login: { title: "Iniciar sesión", sub: "Acceda a su espacio de gestión." },
      forgot: {
    ...
    accountToggle: { agent: "Agente MSP", client: "Portal cliente" },
    back: "← Volver",
    mfa: {
    ...
    outage: {
      ...
      lead:
        "Veritas no está disponible temporalmente. Nuestro equipo técnico está trabajando activamente para resolver el problema.",
