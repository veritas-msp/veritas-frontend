...
export default function SiteMapModal({
  ...
  const interactiveMapTitle = interpolate(editor.interactiveMapTitle, { label: mapLabel });

  const embedUrl = buildOsmEmbedUrl(latitude, longitude, { zoom: 16 });
