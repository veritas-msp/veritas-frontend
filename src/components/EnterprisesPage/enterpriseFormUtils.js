...
export function mapContactToPrimary(contact) {
  ...
  return {
    ...
    sexe: contact.sexe || "",
    email:
      getPrimaryCommunicationValue(communications, "email") || contact.email || "",
    telephone:
      getPrimaryCommunicationValue(communications, "telephone") ||
      contact.telephone ||
      "",
    poste: contact.poste || "",
    communications,
...
export function normalizePrimaryContact(contact) {
  ...
  return {
    ...
    email:
      getPrimaryCommunicationValue(communications, "email") ||
...
export function getContactSearchText(contact) {
  ...
  const email =
    getPrimaryCommunicationValue(communications, "email") || contact?.email || "";
  const telephone =
    getPrimaryCommunicationValue(communications, "telephone") || contact?.telephone || "";
