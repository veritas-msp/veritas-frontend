    ...
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          {titleIcon ? (
            <div className={`${styles.headerIconWrap} ${styles[`headerIconWrap_${accentKey}`]}`} aria-hidden>
              <Icon icon={titleIcon} />
            </div>
          ) : null}
              ...
              entry.type === "group" ? (
                ...
                <button
                  ...
                  className={`${styles.navItem} ${
                    activeSection === entry.section.id ? styles.navItemActive : ""
                  }`}
