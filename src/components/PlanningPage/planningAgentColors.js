/** Palette stable · couleurs suffisamment foncées pour du texte blanc. */
export const PLANNING_AGENT_PALETTE = [
  "#2563eb",
  "#7c3aed",
  "#c026d3",
  "#db2777",
...
/** Couleur de l'événement = couleur de l'agent (ligne semaine ou premier assigné). */
