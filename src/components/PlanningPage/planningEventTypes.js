...
export const PLANNING_LEGEND_ITEMS = [...PLANNING_EVENT_TYPES.filter(type => type.value !== "campagne"), ...PLANNING_SUPPORT_LEGEND, PLANNING_EVENT_TYPES.find(type => type.value === "campagne")].filter(Boolean);
