...
export const computeWifiHealthScore = (wifiData = {}, {
  eventsCount = null,
...
const WifiSummaryCards = ({
  ...
  return <div className={`${styles.container} ${theme === "dark" ? styles.dark : ""}`}>
      ...
      gridTemplateColumns: `repeat(${siteCount}, minmax(0, 1fr))`
        ...
        {siteEntries.map(([siteName, siteWifis]) => <div key={siteName} className={styles.siteGroup}>
            ...
            const healthLetter = resolvedScore !== undefined && resolvedScore !== null ? scoreToLetter(resolvedScore) : getWifiLetterFromStatus(statusFallback.status);
            ...
            const identityPartsLeft = [wf.marque || wf.fabricant, wf.modele, wf.sn || wf.numeroSerie ? `S/N ${wf.sn || wf.numeroSerie}` : null].filter(Boolean);
            const identityPartsRight = [wf.ip || wf.general?.ip].filter(Boolean);
              ...
              gridColumn: 'span 2'
                    ...
                    <div className={styles.cardContent}>
                      ...
                      <div className={styles.healthTitleRow}>
                        ...
                        {wf.garantie && <div className={styles.serverLicenseRow}>
                      ...
                      color: healthLetter === "A" || healthLetter === "B" ? "#10b981" : healthColor
                          ...
                          <div className={styles.healthInfos}>
                            ...
                            return <div key={`${wifiName}-${service.label}`} className={styles.serviceStatCard}>
                    ...
                    {wifiData.comment && <div className={styles.commentBubble} style={{
