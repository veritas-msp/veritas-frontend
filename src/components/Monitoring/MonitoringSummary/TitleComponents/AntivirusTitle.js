...
export default function AntivirusTitle({ data, config }) {
  ...
  const healthScore = useMemo(() => {
    ...
    // Prendre la première solution pour le calcul
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
        <div style={{ flex: 1 }}>
          <div className={styles.cyberModuleSubTitle}>
            <Icon path={mdiBug} size={1} color="#000000" style={{ width: '50px', height: '50px' }} />
            <h2>ANTIVIRUS</h2>
          </div>
