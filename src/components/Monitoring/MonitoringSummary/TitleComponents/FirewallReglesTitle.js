...
export default function FirewallReglesTitle({ data, config }) {
  const { theme } = useTheme();
  
  // Calcul du score de santé (identique à FirewallsSummary.js)
        ...
        <div style={{ flex: 1 }}>
          <div className={styles.cyberModuleSubTitle}>
            <IconifyIcon
              ...
              color="#000000"
            />
            <h2>REGLES DU FIREWALL</h2>
          </div>
          <p className={styles.cyberModuleSubTitleDescription}>
            Règles de filtrage et contrôle d'accès
          </p>
        </div>
        {finalScore !== null && (
          <div style={{
