...
const SIDEBAR_GUIDE_COPY = {
  fr: {
    ...
    intro: {
      ...
      content:
        "Ce guide vous présente le menu latéral : votre point d'entrée vers les entreprises, le support, la supervision et le pilotage.",
    },
    brand: {
      title: "Accueil",
    ...
    utilities: {
      ...
      content:
        "Relancez ce guide avec ?, basculez le thème clair/sombre et consultez vos notifications.",
    },
    account: {
      title: "Votre compte",
  ...
  en: {
    ...
    intro: {
      ...
      content:
        "This tour walks you through the sidebar — your hub for companies, support, monitoring, and management.",
    },
    brand: {
      title: "Home",
    ...
    managed: {
      ...
      content: "Supervision, cybersecurity, and cloud — run your clients' infrastructure.",
    },
    pilotage: {
      title: "Management",
  ...
  de: {
    ...
    intro: {
      ...
      content:
        "Diese Führung zeigt die Seitenleiste — Ihr Einstieg zu Unternehmen, Support, Überwachung und Steuerung.",
    },
    brand: {
      title: "Startseite",
  ...
  it: {
    ...
    intro: {
      ...
      content:
        "Questa guida presenta la barra laterale — l'hub per aziende, supporto, supervisione e gestione.",
    },
    brand: {
      title: "Home",
  ...
  es: {
    ...
    intro: {
      ...
      content:
        "Este recorrido presenta la barra lateral — su centro para empresas, soporte, supervisión y gestión.",
    },
    brand: {
      title: "Inicio",
...
export function buildSidebarGuideSteps({
  ...
  return { steps, tourTitle: copy.tourTitle, helpAria: copy.helpAria };
}
