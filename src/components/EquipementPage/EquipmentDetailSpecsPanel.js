    ...
    return <section className={`${styles.panel} ${styles.panelRmmSlim}`}>
        ...
        <div className={styles.rmmVeritasStrip}>
          ...
          <div className={styles.rmmVeritasFields}>
            {inlineFields.map(field => <SpecField key={field.key} field={field} remoteAccessAction={remoteAccessAction} equipmentLink={field.key === "firewallHAName" && haPeer && onOpenEquipment ? {
