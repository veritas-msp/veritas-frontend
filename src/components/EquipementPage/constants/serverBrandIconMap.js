/**
 * Icônes marques serveur · réutilise le mapping firewall/routeur + marques spécifiques.
 */
...
const SERVER_SPECIFIC_ICON_MAP = {
  Dell: { type: "iconify", icon: "simple-icons:dell" },
  Lenovo: { type: "iconify", icon: "simple-icons:lenovo" },
  FUJITSU: { type: "iconify", icon: "simple-icons:fujitsu" },
};
...
export default function ServerBrandIcon({ brand, className }) {
