/**
 * Icônes de marques firewall · simple-icons (Iconify) + SVG intégrés pour les absentes.
 * Couleur uniforme via CSS (currentColor), pas de couleurs officielles par marque.
 */
...
function BrandSvg({ className, viewBox, children }) {
  return (
    <svg
      className={className}
      viewBox={viewBox}
...
/** Pictogramme Check Point (symbole extrait du logo officiel) */
function CheckPointIcon({ className }) {
  return (
    <BrandSvg className={className} viewBox="0 0 36 44">
...
/** Symbole Zscaler (extrait du logo officiel) */
function ZscalerIcon({ className }) {
  return (
    <BrandSvg className={className} viewBox="0 0 88 54">
...
function StormshieldIcon({ className }) {
  return (
    <img
      src={getAssetPath("assets/brands/stormshield.png")}
      className={`${className} ${formStyles.moduleTileBrandLogoImg}`}
      alt=""
      draggable={false}
    />
  );
...
function SophosIcon({ className }) {
  return (
    <BrandSvg className={className} viewBox="0 0 25 20">
...
function WatchGuardIcon({ className }) {
  return (
    <BrandSvg className={className} viewBox="0 0 52 54">
...
function HpeIcon({ className }) {
  return (
    <BrandSvg className={className} viewBox="0 0 48 20">
      <text
        x="24"
        y="15"
        textAnchor="middle"
...
function DynFiIcon({ className }) {
  return (
    <BrandSvg className={className} viewBox="0 0 24 24">
...
export const FIREWALL_BRAND_ICON_MAP = {
  Stormshield: { type: "component", Component: StormshieldIcon },
  Fortinet: { type: "iconify", icon: "simple-icons:fortinet" },
  PaloAltoNetworks: { type: "iconify", icon: "simple-icons:paloaltonetworks" },
  CheckPoint: { type: "component", Component: CheckPointIcon },
  Sophos: { type: "component", Component: SophosIcon },
  WatchGuard: { type: "component", Component: WatchGuardIcon },
  Cisco: { type: "iconify", icon: "simple-icons:cisco" },
  SonicWall: { type: "iconify", icon: "simple-icons:sonicwall" },
  Juniper: { type: "iconify", icon: "simple-icons:junipernetworks" },
  Ubiquiti: { type: "iconify", icon: "simple-icons:ubiquiti" },
  pfSense: { type: "iconify", icon: "simple-icons:pfsense" },
  Huawei: { type: "iconify", icon: "simple-icons:huawei" },
  HPE: { type: "component", Component: HpeIcon },
  OPNsense: { type: "iconify", icon: "simple-icons:opnsense" },
  DynFi: { type: "component", Component: DynFiIcon },
  MicrosoftAzure: { type: "iconify", icon: "simple-icons:microsoftazure" },
  AWS: { type: "iconify", icon: "simple-icons:amazonwebservices" },
  Cloudflare: { type: "iconify", icon: "simple-icons:cloudflare" },
  GoogleCloud: { type: "iconify", icon: "simple-icons:googlecloud" },
  Zscaler: { type: "component", Component: ZscalerIcon },
};
