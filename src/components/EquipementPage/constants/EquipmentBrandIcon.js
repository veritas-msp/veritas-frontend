...
function renderTypeFallback(type, className, size) {
  return (
    <Icon
      icon={TYPE_FALLBACK_ICONS[type] || "mdi:devices"}
      className={className}
      width={size}
      height={size}
      aria-hidden
...
export default function EquipmentBrandIcon({
  ...
  if (type === "Firewalls") {
    return (
      <FirewallBrandIcon
        brand={resolveBrandId(equipment, getEquipmentFirewallBrandId)}
        className={className}
      />
    );
  }
  ...
  if (type === "Routeur") {
    return (
      <RouterBrandIcon
        brand={resolveBrandId(equipment, getEquipmentRouterBrandId)}
        className={className}
      />
    );
  }
  ...
  if (type === "Serveurs") {
    ...
    return (
      <ServerBrandIcon
        brand={resolveBrandId(equipment, getEquipmentServerBrandId)}
        className={className}
      />
    );
  }
  ...
  if (type === "Stockage" || type === "NAS") {
    ...
    return (
      <Icon
        icon={getStorageTypeIconName(equipment)}
        className={className}
        width={size}
        height={size}
        aria-hidden
  ...
  if (type === "Switch") {
    return (
      <SwitchBrandIcon
        brand={resolveFirewallBrandId(manufacturer) || manufacturer}
        className={className}
      />
    );
  }
  ...
  if (type === "Internet") {
    return (
      <Icon
        icon={getInternetConnectionIconName(equipment)}
        className={className}
        width={size}
        height={size}
        aria-hidden
  ...
  if (type === "Sauvegarde") {
    ...
    return renderTypeFallback("Sauvegarde", className, size);
  }
