...
const STORAGE_SPECIFIC_ICON_MAP = {
  SYNOLOGY: { type: "iconify", icon: "simple-icons:synology" },
  QNAP: { type: "iconify", icon: "simple-icons:qnap" },
  NetApp: { type: "iconify", icon: "simple-icons:netapp" },
  PureStorage: { type: "iconify", icon: "mdi:database-outline" },
  Quantum: { type: "iconify", icon: "mdi:backup-restore" },
  WesternDigital: { type: "iconify", icon: "simple-icons:westerndigital" },
  Asustor: { type: "iconify", icon: "mdi:nas" },
  Netgear: { type: "iconify", icon: "simple-icons:netgear" },
  IBM: { type: "iconify", icon: "simple-icons:ibm" },
  Wasabi: { type: "iconify", icon: "mdi:cloud-outline" },
  OVHcloud: { type: "iconify", icon: "simple-icons:ovh" },
};
...
export default function StorageBrandIcon({ brand, className }) {
