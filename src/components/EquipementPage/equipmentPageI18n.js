...
const PAGE_COPY = {
  fr: {
    ...
    typeOverrides: {
      Firewalls: { manufacturer: "Marque", serial: "SN" },
      Internet: { internetType: "Type de connexion" },
      Serveurs: { vlan: "VLAN", processeur: "Proc.", role: "Rôles" },
      Stockage: { raid: "RAID" },
      Switch: { manufacturer: "Marque" },
      BorneWifi: { manufacturer: "Marque" },
      Ordinateurs: { systeme: "OS", domaine: "Domaine", agentStatus: "Agent" },
      Sauvegarde: { name: "Logiciel", jobsCount: "Jobs", mappedJobsCount: "Jobs mappés" },
    },
    empty: {
      Internet: { embedded: "Aucun périphérique Internet pour ce client.", default: "Aucun périphérique Internet trouvé." },
      Firewalls: { embedded: "Aucun pare-feu pour ce client.", default: "Aucun pare-feu trouvé." },
      Serveurs: { embedded: "Aucun serveur pour ce client.", default: "Aucun serveur trouvé." },
      Ordinateurs: { embedded: "Aucun ordinateur pour ce client.", default: "Aucun ordinateur trouvé." },
      Stockage: { embedded: "Aucun périphérique de stockage pour ce client.", default: "Aucun périphérique de stockage trouvé." },
      Switch: { embedded: "Aucun switch pour ce client.", default: "Aucun switch trouvé." },
      BorneWifi: { embedded: "Aucune borne WiFi pour ce client.", default: "Aucune borne WiFi trouvée." },
      Alimentation: { embedded: "Aucun équipement d'alimentation pour ce client.", default: "Aucun équipement d'alimentation trouvé." },
      Routeur: { embedded: "Aucun routeur pour ce client.", default: "Aucun routeur trouvé." },
      TOIP: { embedded: "Aucun équipement TOIP pour ce client.", default: "Aucun équipement TOIP trouvé." },
      Sauvegarde: { embedded: "Aucune instance de sauvegarde pour ce client.", default: "Aucune instance de sauvegarde trouvée." },
      "Caméra de sécurité": { embedded: "Aucune caméra de sécurité pour ce client.", default: "Aucune caméra de sécurité trouvée." },
      default: { embedded: "Aucun équipement pour ce client.", default: "Aucun équipement trouvé." },
    },
  },
  en: {
    ...
    columns: {
      ...
      maintenanceLicence: "Maintenance licence date",
      systeme: "OS",
      domaine: "Domain",
    ...
    typeOverrides: {
      Firewalls: { manufacturer: "Brand", serial: "SN" },
      Internet: { internetType: "Connection type" },
      Serveurs: { vlan: "VLAN", processeur: "CPU", role: "Roles" },
      Stockage: { raid: "RAID" },
      Switch: { manufacturer: "Brand" },
      BorneWifi: { manufacturer: "Brand" },
      Ordinateurs: { systeme: "OS", domaine: "Domain", agentStatus: "Agent" },
      Sauvegarde: { name: "Software", jobsCount: "Jobs", mappedJobsCount: "Mapped jobs" },
    },
    empty: {
      Internet: { embedded: "No internet link for this client.", default: "No internet link found." },
      Firewalls: { embedded: "No firewall for this client.", default: "No firewall found." },
      Serveurs: { embedded: "No server for this client.", default: "No server found." },
      Ordinateurs: { embedded: "No computer for this client.", default: "No computer found." },
      Stockage: { embedded: "No storage device for this client.", default: "No storage device found." },
      Switch: { embedded: "No switch for this client.", default: "No switch found." },
      BorneWifi: { embedded: "No WiFi AP for this client.", default: "No WiFi AP found." },
      Alimentation: { embedded: "No power device for this client.", default: "No power device found." },
      Routeur: { embedded: "No router for this client.", default: "No router found." },
      TOIP: { embedded: "No VoIP device for this client.", default: "No VoIP device found." },
      Sauvegarde: { embedded: "No backup instance for this client.", default: "No backup instance found." },
      "Caméra de sécurité": { embedded: "No security camera for this client.", default: "No security camera found." },
      default: { embedded: "No equipment for this client.", default: "No equipment found." },
    },
  },
  de: {
    ...
    no: "Nein",
    columns: {
      name: "Name", monitoring: "Überwachung", client: "Kunde", location: "Standort", processeur: "vCPU/CPU",
      memoire: "RAM", stockage: "Speicher", ip: "IP-Adresse", serial: "Seriennummer", mapping: "Aktion",
      model: "Modell", manufacturer: "Hersteller", version: "Version", mac: "MAC-Adresse", uptime: "Uptime",
      installDate: "Installationsdatum", nbDisques: "Anzahl Festplatten", capacite: "Gesamtkapazität (GB)",
      fournisseur: "Anbieter", internetType: "Typ", categorie: "Kategorie", debit: "Bandbreite", vlan: "VLAN",
      firmware: "Firmware", expirationGarantie: "Garantiedatum", maintenanceLicence: "Wartungslizenz",
      systeme: "OS", domaine: "Domäne", agentStatus: "RMM-Agent", role: "Rollen", raid: "RAID",
      nbDisquesActuels: "Aktuelle Festplatten", nbDisquesMax: "Max. Festplatten", server: "Server",
      jobsCount: "Jobs", mappedJobsCount: "Zugeordnete Jobs", logiciel: "Software",
    },
    typeOverrides: {
      Firewalls: { manufacturer: "Marke", serial: "SN" },
      Internet: { internetType: "Verbindungstyp" },
      Serveurs: { vlan: "VLAN", processeur: "CPU", role: "Rollen" },
      Ordinateurs: { systeme: "OS", domaine: "Domäne", agentStatus: "Agent" },
      Sauvegarde: { name: "Software", jobsCount: "Jobs", mappedJobsCount: "Zugeordnete Jobs" },
    },
    empty: {
      Internet: { embedded: "Keine Internetverbindung für diesen Kunden.", default: "Keine Internetverbindung gefunden." },
      Firewalls: { embedded: "Keine Firewall für diesen Kunden.", default: "Keine Firewall gefunden." },
      Serveurs: { embedded: "Kein Server für diesen Kunden.", default: "Kein Server gefunden." },
      Ordinateurs: { embedded: "Kein Computer für diesen Kunden.", default: "Kein Computer gefunden." },
      Stockage: { embedded: "Kein Speichergerät für diesen Kunden.", default: "Kein Speichergerät gefunden." },
      Switch: { embedded: "Kein Switch für diesen Kunden.", default: "Kein Switch gefunden." },
      BorneWifi: { embedded: "Kein WLAN-AP für diesen Kunden.", default: "Kein WLAN-AP gefunden." },
      Alimentation: { embedded: "Kein Stromgerät für diesen Kunden.", default: "Kein Stromgerät gefunden." },
      Routeur: { embedded: "Kein Router für diesen Kunden.", default: "Kein Router gefunden." },
      TOIP: { embedded: "Kein VoIP-Gerät für diesen Kunden.", default: "Kein VoIP-Gerät gefunden." },
      Sauvegarde: { embedded: "Keine Backup-Instanz für diesen Kunden.", default: "Keine Backup-Instanz gefunden." },
      default: { embedded: "Kein Gerät für diesen Kunden.", default: "Kein Gerät gefunden." },
    },
  },
  it: {
    ...
    no: "No",
    columns: {
      name: "Nome", monitoring: "Monitoraggio", client: "Cliente", location: "Sede", processeur: "vCPU/CPU",
      memoire: "RAM", stockage: "Storage", ip: "Indirizzo IP", serial: "Numero di serie", mapping: "Azione",
      model: "Modello", manufacturer: "Produttore", version: "Versione", mac: "Indirizzo MAC", uptime: "Uptime",
      installDate: "Data installazione", nbDisques: "N. dischi", capacite: "Capacità totale (GB)",
      fournisseur: "Fornitore", internetType: "Tipo", categorie: "Categoria", debit: "Banda", vlan: "VLAN",
      firmware: "Firmware", expirationGarantie: "Data garanzia", maintenanceLicence: "Licenza manutenzione",
      systeme: "OS", domaine: "Dominio", agentStatus: "Agente RMM", role: "Ruoli", raid: "RAID",
      nbDisquesActuels: "Dischi attuali", nbDisquesMax: "Dischi max", server: "Server",
      jobsCount: "Job", mappedJobsCount: "Job mappati", logiciel: "Software",
    },
    typeOverrides: {
      Firewalls: { manufacturer: "Marca", serial: "SN" },
      Internet: { internetType: "Tipo connessione" },
      Serveurs: { vlan: "VLAN", processeur: "CPU", role: "Ruoli" },
      Ordinateurs: { systeme: "OS", domaine: "Dominio", agentStatus: "Agente" },
      Sauvegarde: { name: "Software", jobsCount: "Job", mappedJobsCount: "Job mappati" },
    },
    empty: {
      Internet: { embedded: "Nessun collegamento internet per questo cliente.", default: "Nessun collegamento internet trovato." },
      Firewalls: { embedded: "Nessun firewall per questo cliente.", default: "Nessun firewall trovato." },
      Serveurs: { embedded: "Nessun server per questo cliente.", default: "Nessun server trovato." },
      Ordinateurs: { embedded: "Nessun computer per questo cliente.", default: "Nessun computer trovato." },
      Stockage: { embedded: "Nessun dispositivo storage per questo cliente.", default: "Nessun dispositivo storage trovato." },
      Switch: { embedded: "Nessuno switch per questo cliente.", default: "Nessuno switch trovato." },
      BorneWifi: { embedded: "Nessun AP WiFi per questo cliente.", default: "Nessun AP WiFi trovato." },
      Alimentation: { embedded: "Nessun dispositivo di alimentazione per questo cliente.", default: "Nessun dispositivo di alimentazione trovato." },
      Routeur: { embedded: "Nessun router per questo cliente.", default: "Nessun router trovato." },
      TOIP: { embedded: "Nessun dispositivo VoIP per questo cliente.", default: "Nessun dispositivo VoIP trovato." },
      Sauvegarde: { embedded: "Nessuna istanza backup per questo cliente.", default: "Nessuna istanza backup trovata." },
      default: { embedded: "Nessun dispositivo per questo cliente.", default: "Nessun dispositivo trovato." },
    },
  },
  es: {
    ...
    no: "No",
    columns: {
      name: "Nombre", monitoring: "Monitorización", client: "Cliente", location: "Sitio", processeur: "vCPU/CPU",
      memoire: "RAM", stockage: "Almacenamiento", ip: "Dirección IP", serial: "Número de serie", mapping: "Acción",
      model: "Modelo", manufacturer: "Fabricante", version: "Versión", mac: "Dirección MAC", uptime: "Uptime",
      installDate: "Fecha de instalación", nbDisques: "N.º discos", capacite: "Capacidad total (GB)",
      fournisseur: "Proveedor", internetType: "Tipo", categorie: "Categoría", debit: "Ancho de banda", vlan: "VLAN",
      firmware: "Firmware", expirationGarantie: "Fecha de garantía", maintenanceLicence: "Licencia mantenimiento",
      systeme: "SO", domaine: "Dominio", agentStatus: "Agente RMM", role: "Roles", raid: "RAID",
      nbDisquesActuels: "Discos actuales", nbDisquesMax: "Discos máx.", server: "Servidor",
      jobsCount: "Jobs", mappedJobsCount: "Jobs mapeados", logiciel: "Software",
    },
    typeOverrides: {
      Firewalls: { manufacturer: "Marca", serial: "SN" },
      Internet: { internetType: "Tipo de conexión" },
      Serveurs: { vlan: "VLAN", processeur: "CPU", role: "Roles" },
      Ordinateurs: { systeme: "SO", domaine: "Dominio", agentStatus: "Agente" },
      Sauvegarde: { name: "Software", jobsCount: "Jobs", mappedJobsCount: "Jobs mapeados" },
    },
    empty: {
      Internet: { embedded: "Ninguna conexión internet para este cliente.", default: "Ninguna conexión internet encontrada." },
      Firewalls: { embedded: "Ningún firewall para este cliente.", default: "Ningún firewall encontrado." },
      Serveurs: { embedded: "Ningún servidor para este cliente.", default: "Ningún servidor encontrado." },
      Ordinateurs: { embedded: "Ningún ordenador para este cliente.", default: "Ningún ordenador encontrado." },
      Stockage: { embedded: "Ningún dispositivo de almacenamiento para este cliente.", default: "Ningún dispositivo de almacenamiento encontrado." },
      Switch: { embedded: "Ningún switch para este cliente.", default: "Ningún switch encontrado." },
      BorneWifi: { embedded: "Ningún AP WiFi para este cliente.", default: "Ningún AP WiFi encontrado." },
      Alimentation: { embedded: "Ningún equipo de alimentación para este cliente.", default: "Ningún equipo de alimentación encontrado." },
      Routeur: { embedded: "Ningún router para este cliente.", default: "Ningún router encontrado." },
      TOIP: { embedded: "Ningún equipo VoIP para este cliente.", default: "Ningún equipo VoIP encontrado." },
      Sauvegarde: { embedded: "Ninguna instancia de backup para este cliente.", default: "Ninguna instancia de backup encontrada." },
      default: { embedded: "Ningún equipo para este cliente.", default: "Ningún equipo encontrado." },
    },
  },
};
...
export function formatEquipmentRemoteAccessTooltip(locale, { configured, url, equipmentType }) {
  const actions = getEquipmentPageCopy(locale).actions;
  if (!configured) {
    return equipmentType === "Switch"
      ? actions.remoteAccessSwitchUrlMissing
      : actions.remoteAccessUrlMissing;
  }
...
export function formatEquipmentServerRemoteTooltip(locale, { solutionLabel, id } = {}) {
  const actions = getEquipmentPageCopy(locale).actions;
