export const REMOTE_ACCESS_LABEL = "Connexion distante";
export const REMOTE_ACCESS_NOT_CONFIGURED = "Connexion distante non configurée";
...
export function getRemoteAccessUrl(equipment) {
  ...
  if (equipment.type === "Firewalls") {
    return String(
      equipment.stormshieldWanUrl
        || data.stormshieldWanUrl
        || data.adminUrl
        || data.urlAdministration
        || ""
    ).trim();
  }
