...
import {
  ...
  setMaintenanceLicenceExpiration,
...
const StepFirewalls = ({ form, setForm, onAdd, currentStepData }) => {
  ...
  const updateFirewallBrand = (index, brand) => {
    ...
    updated[index] = {
      ...
      fabricant: brand,
      modele: "",
      ...(!isStormshieldBrand(brand) ? { stormshieldWanUrl: "" } : {}),
    };
    setForm((prev) => ({
      ...prev,
      equipements: { ...prev.equipements, Firewalls: updated },
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.formGrid} style={{ gridTemplateColumns: '1fr 1fr 1fr' }}>
                    <BrandModelFields
                      catalog={FIREWALL_CATALOG}
                      manufacturer={firewall.fabricant}
                      model={firewall.modele}
                      manufacturerId={`fw-fabricant-${i}`}
                      modelId={`fw-modele-${i}`}
                      fieldClassName={styles.formField}
                      labelClassName={undefined}
                      inputClassName={undefined}
                      onManufacturerChange={(value) => updateFirewallBrand(i, value)}
                  ...
                  {isStormshieldBrand(firewall.fabricant) && (
                    <div className={styles.formGrid} style={{ gridTemplateColumns: '1fr' }}>
                      <div className={styles.formField}>
                        <label htmlFor={`fw-wan-${i}`}>Lien de connexion WAN</label>
                        <input
                          id={`fw-wan-${i}`}
                          type="url"
                          value={firewall.stormshieldWanUrl || ""}
                          onChange={(e) => update(i, "stormshieldWanUrl", e.target.value)}
                          placeholder="https://..."
                        />
                      </div>
                    </div>
                  ...
                  {/* Ligne 4 : Garantie et licence maintenance */}
                  <div className={styles.formGrid} style={{ gridTemplateColumns: '1fr 1fr' }}>
                    <div className={styles.formField}>
                    ...
                    <div className={styles.formField}>
                      <label htmlFor={`fw-maintenance-${i}`}>Licence maintenance (expiration)</label>
                      <input
                        id={`fw-maintenance-${i}`}
                        type="date"
                        value={getMaintenanceLicenceExpiration(firewall.licences)}
                        onChange={(e) =>
                          update(
                            i,
                            "licences",
                            setMaintenanceLicenceExpiration(firewall.licences, e.target.value)
                          )
                        }
                      />
                    </div>
