...
const CYBER_MODALS = {
  fr: {
    ...
    resetCampaign:
      "Remettre la campagne à zéro supprimera les snapshots de début et de fin. Vous pourrez ensuite la lancer à nouveau. Continuer ?",
  },
  en: {
    ...
    resetCampaign:
      "Resetting the campaign will remove start and end snapshots. You can launch it again afterwards. Continue?",
  },
  de: {
    ...
    resetCampaign:
      "Das Zurücksetzen der Kampagne entfernt Start- und End-Snapshots. Sie können sie danach erneut starten. Fortfahren?",
  },
  it: {
    ...
    resetCampaign:
      "Azzerare la campagna rimuoverà gli snapshot iniziale e finale. Potrai rilanciarla in seguito. Continuare?",
  },
  es: {
    ...
    resetCampaign:
      "Restablecer la campaña eliminará las instantáneas de inicio y fin. Podrá relanzarla después. ¿Continuar?",
  },
};
